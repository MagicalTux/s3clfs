...
protected:
	...
	virtual void fuse_lookup(QtFuseRequest *req);
	virtual void fuse_forget(fuse_ino_t node, unsigned long nlookup);
	virtual void fuse_getattr(QtFuseRequest *req);
	virtual void fuse_setattr(QtFuseRequest *req);
	virtual void fuse_readlink(QtFuseRequest *req);
	virtual void fuse_mkdir(QtFuseRequest *req);
	virtual void fuse_unlink(QtFuseRequest *req);
	virtual void fuse_rmdir(QtFuseRequest *req);
	virtual void fuse_symlink(QtFuseRequest *req);
	virtual void fuse_rename(QtFuseRequest *req);
	virtual void fuse_link(QtFuseRequest *req);
	virtual void fuse_mknod(QtFuseRequest *req);
	virtual void fuse_open(QtFuseRequest *req);
	virtual void fuse_read(QtFuseRequest *req);
	virtual void fuse_write(QtFuseRequest *req);
	virtual void fuse_flush(QtFuseRequest *req);
	virtual void fuse_release(QtFuseRequest *req);
	virtual void fuse_fsync(QtFuseRequest *req);
	virtual void fuse_opendir(QtFuseRequest *req);
	virtual void fuse_readdir(QtFuseRequest *req);
	virtual void fuse_releasedir(QtFuseRequest *req);
	virtual void fuse_fsyncdir(QtFuseRequest *req);
	virtual void fuse_statfs(QtFuseRequest *req);
	virtual void fuse_setxattr(QtFuseRequest *req);
	virtual void fuse_getxattr(QtFuseRequest *req);
	virtual void fuse_listxattr(QtFuseRequest *req);
	virtual void fuse_removexattr(QtFuseRequest *req);
	virtual void fuse_access(QtFuseRequest *req);
	virtual void fuse_create(QtFuseRequest *req);
